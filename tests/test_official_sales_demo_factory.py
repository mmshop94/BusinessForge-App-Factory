...
def test_official_sales_demo_slug_count() -> None:
    ...
    assert "demo-butcher" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-farm-shop" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-beverage-store" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-delicatessen" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-winery" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-cheese-shop" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-fish-shop" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-garden-center" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-pet-supply" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-vehicle-detailing" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-cleaning-service" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-landscaping-service" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-caretaker" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-pet-grooming" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-piercing" in OFFICIAL_SALES_DEMO_SLUGS
    ...
    assert "demo-appliance-service" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-hvac-service" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-sanitary-service" in OFFICIAL_SALES_DEMO_SLUGS
    assert "demo-auto-workshop" in OFFICIAL_SALES_DEMO_SLUGS
    ...
    assert "test-commerce-florist" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-butcher" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-farm-shop" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-beverage-store" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-delicatessen" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-winery" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-cheese-shop" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-fish-shop" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-garden-center" not in OFFICIAL_SALES_DEMO_SLUGS
    assert "test-commerce-pet-supply" not in OFFICIAL_SALES_DEMO_SLUGS

...
- Docs: Appliance Full Visual + Cross-UI **PROVEN** (`bf-e2e-visual-service-appliance-20260912-061103`) · Certificate Ready **YES** · issued **NO** · wait for `SERVICE_APPLIANCE_SERVICE_VERSIONED_VERTICAL_CERTIFICATION_V1`; no App Factory packaging yet; not GPS; 11/11 sales batch unchanged.

...
- Docs: HVAC Service reference vertical **PROVEN** (H01–H24) · package `field_service_hvac@v1` / `HVAC_SERVICE` / `test-service-hvac` · Certificate Ready **NO** · Visual **NOT_PROVEN** · wait for `SERVICE_HVAC_SERVICE_FULL_VISUAL_CROSSUI_V1`; no HVAC App Factory forks; Sanitary remains AUDITED/UNREGISTERED; not GPS; 11/11 sales batch unchanged.

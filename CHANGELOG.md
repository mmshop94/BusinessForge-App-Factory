...
- Docs: BICYCLE Full Visual + Cross-UI **PROVEN** (`bf-e2e-visual-service-bicycle-20260911-132941`) — wait for versioned vertical certification; 11/11 sales batch unchanged.

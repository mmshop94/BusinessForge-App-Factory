...
- Docs: FIELD Load25 **PROVEN** (`bf-e2e-load25-service-field-20260911-183324`) · wait for `SERVICE_FIELD_LOAD50_PROOF_V1` (`WAIT_FOR_SERVICE_FIELD_LOAD50_PROOF_V1`); electrician remains reference config only; not certificate; not GPS; 11/11 sales batch unchanged.

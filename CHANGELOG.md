...
- Docs: Appliance Certificate **CURRENT** (`cert-service-appliance-v1`, production_active **NO**, PRODUCTION_APPROVED_WITH_FINDINGS, **CONFIG_ONLY**) after certification V1 · **STOP** Appliance certification wait · packaging may proceed under existing App Factory rules without inventing appliance forks · next prefer FIELD CONFIG_ONLY audit before NEW_SERVICE_CLASS; not GPS; 11/11 sales batch unchanged.

...
OFFICIAL_SALES_DEMO_SLUGS: tuple[str, ...] = (
    ...
    "demo-foot-care",
    "demo-pet-grooming",
    "demo-bicycle-workshop",
    "demo-device-shop",
    "demo-motorcycle-workshop",
    "demo-electrician",
...
_FALLBACK_BRANDING: dict[str, tuple[str, str, str]] = {
    ...
    "demo-farm-shop": ("warm", "#5C4033", "#E8F0D8"),
    ...
    "demo-fish-shop": ("warm", "#0369A1", "#E0F2FE"),
    "demo-garden-center": ("warm", "#166534", "#DCFCE7"),
    "demo-pet-supply": ("warm", "#9A3412", "#FFEDD4"),
...
def _features_for_package(package: str) -> dict[str, bool]:
    ...
    if package.startswith("service_") or package.startswith("field_service_"):
        return {
    ...
    *,
    ...
    with httpx.Client(timeout=timeout) as client:
        ...
        for slug in slugs:
            ...
            if slug == "demo-farm-shop":
                runtime_package = runtime_package or "village_store"
            if slug == "demo-beverage-store":
                runtime_package = runtime_package or "village_store"
            ...
            if slug == "demo-cheese-shop":
                runtime_package = runtime_package or "village_store"
            if slug == "demo-fish-shop":
                runtime_package = runtime_package or "village_store"
            if slug == "demo-garden-center":
                runtime_package = runtime_package or "village_store"
            if slug == "demo-pet-supply":
                runtime_package = runtime_package or "village_store"
            if slug == "demo-bicycle-workshop":
                runtime_package = runtime_package or "service_bicycle_workshop"
            if slug == "demo-device-shop":
                runtime_package = runtime_package or "service_device_shop"
            if slug == "demo-motorcycle-workshop":
                runtime_package = runtime_package or "service_motorcycle_workshop"
            if slug == "demo-electrician":
                runtime_package = runtime_package or "field_service_electrician"
            if slug == "demo-appliance-service":
            ...
            if slug == "demo-vehicle-detailing":
                runtime_package = runtime_package or "service_vehicle_detailing"
            if slug == "demo-cleaning-service":

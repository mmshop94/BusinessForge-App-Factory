...
> **Latest public rebuild:** Push Device Registration V3-02 — **11/11** APK+AAB (historical). Slug list authority now **18** with commerce sales demos through `demo-winery`. Rebuild public batch after demo-plane bootstrap.
> **Status:** READY for bakery … winery slug discovery · APK rebuild deferred to demo ops

...
| Remaining | Next: `SERVICE_APPLIANCE_SERVICE_FULL_VISUAL_CROSSUI_V1` after reference PROVEN (`appliance_service` CONFIG_ONLY REGISTERED) |
| APPLIANCE_SERVICE | **CONFIG_ONLY** · Functional A01–A24 **PROVEN** · Visual/Cross-UI **NOT_PROVEN** · Certificate Ready **NO** · Load/Soak/Chaos **INHERITED** · package `field_service_appliance@v1` |

```text
NEXT APP FACTORY SERVICE ACTION: WAIT_FOR_SERVICE_APPLIANCE_SERVICE_FULL_VISUAL_CROSSUI_V1
PRIOR DONE: SERVICE_APPLIANCE_SERVICE_REFERENCE_VERTICAL_PROOF_V1
  → appliance_service REGISTERED · A01–A24 PROVEN · certificate_ready=NO
PRIOR DONE: SERVICE_NEXT_FIELD_VERTICAL_REUSE_GAP_AUDIT_V1
  → appliance_service = CONFIG_ONLY FIELD peer
...
STATUS: Appliance reference PROVEN — wait for Visual before App Factory packaging push
...
Appliance FIELD peer: **`appliance_service`** · **CONFIG_ONLY** · Functional **PROVEN** · Visual **NOT_PROVEN** — wait for `SERVICE_APPLIANCE_SERVICE_FULL_VISUAL_CROSSUI_V1` before App Factory packaging.  
Authority: BusinessForge `SERVICE_APPLIANCE_SERVICE_REFERENCE_VERTICAL_PROOF_V1`.  
